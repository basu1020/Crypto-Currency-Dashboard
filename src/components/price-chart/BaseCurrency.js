...
import { baseCurrencyChanged, selectBaseCurrency } from '../../globalStates/baseCurrencySlice'
...
const BaseCurrencyOptions = () => {
  ...
  return (
    ...
    <select className='p-2 font-bold rounded-lg' onChange={onClickBaseCurrencyChanged} >
